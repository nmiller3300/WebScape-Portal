...
const INITIAL_LEADS = [
  { id:1, businessName:"Rosie's Southern Kitchen", category:"Restaurant",  zip:"30542", phone:"(678) 555-0101", address:"123 Spout Springs Rd, Flowery Branch GA", rating:4.7, reviews:112, status:"new",              priority:true,  source:"Drove By",    assignedTo:null,          coWorkers:[],             claimedBy:null,          claimedAt:null,               demoLink:"",                                   notes:[],                                                                                          outreachLog:[],                                                                                                                     payment:{amount:"",    monthly:"",   billingName:"",              billingEmail:"",                       paymentLink:"",                              status:"unpaid"} },
  { id:2, businessName:"Peak Performance Auto",    category:"Auto Repair", zip:"30501", phone:"(770) 555-0234", address:"456 Oak Ridge Rd, Gainesville GA",        rating:4.9, reviews:178, status:"demo-building",    priority:true,  source:"Google Maps", assignedTo:"nmiller3300", coWorkers:[],             claimedBy:"nmiller3300", claimedAt:"May 13, 10:00 AM",  demoLink:"",                                   notes:[{id:1,author:"nmiller3300",text:"Incredible reviews, zero web presence. High priority.",ts:"May 14, 2:30 PM"}],             outreachLog:[{id:1,date:"May 14",method:"Call",outcome:"Left Voicemail",by:"nmiller3300"}],                                         payment:{amount:"400", monthly:"60", billingName:"",              billingEmail:"",                       paymentLink:"",                              status:"unpaid"} },
  { id:3, businessName:"Lakeside Barbershop",      category:"Barbershop",  zip:"30518", phone:"(770) 555-0388", address:"789 Buford Hwy, Buford GA",               rating:4.8, reviews:203, status:"outreach-sent",    priority:false, source:"Google Maps", assignedTo:"white",       coWorkers:["nmiller3300"], claimedBy:"white",       claimedAt:"May 12, 3:00 PM",   demoLink:"https://lakeside-barber.netlify.app", notes:[{id:1,author:"white",text:"Demo sent via email. Waiting on response.",ts:"May 13, 4:15 PM"}],            outreachLog:[{id:1,date:"May 13",method:"Email",outcome:"No Answer",by:"white"},{id:2,date:"May 14",method:"Text",outcome:"Responded",by:"white"}], payment:{amount:"350", monthly:"50", billingName:"Marcus Johnson",  billingEmail:"marcus@lakesidecutz.com", paymentLink:"",                              status:"pending"} },
  { id:4, businessName:"Blossom Nail Studio",      category:"Nail Salon",  zip:"30542", phone:"(678) 555-0499", address:"321 Friendship Rd, Flowery Branch GA",    rating:4.6, reviews:87,  status:"closed-won",       priority:false, source:"Referral",    assignedTo:"nmiller3300", coWorkers:[],             claimedBy:"nmiller3300", claimedAt:"May 10, 11:00 AM",  demoLink:"https://blossom-nails.netlify.app",   notes:[{id:1,author:"nmiller3300",text:"Signed! $350 build + $50/mo hosting.",ts:"May 12, 11:00 AM"}],              outreachLog:[{id:1,date:"May 10",method:"Call",outcome:"Responded",by:"nmiller3300"}],                                              payment:{amount:"350", monthly:"50", billingName:"Lily Tran",        billingEmail:"lily@blossomstudio.com",  paymentLink:"https://cash.app/$blossomstudio", status:"paid"   } },
  { id:5, businessName:"Iron Gate Crossfit",       category:"Gym",         zip:"30501", phone:"(770) 555-0567", address:"555 Pearl Nix Pkwy, Gainesville GA",       rating:4.5, reviews:64,  status:"declined-designer",priority:false, source:"Google Maps", assignedTo:"nmiller3300", coWorkers:[],             claimedBy:"nmiller3300", claimedAt:"May 11, 9:00 AM",   demoLink:"",                                   notes:[{id:1,author:"nmiller3300",text:"Already using Facebook as site.",ts:"May 11, 9:00 AM"}],                                   outreachLog:[],                                                                                                                     payment:{amount:"",    monthly:"",   billingName:"",              billingEmail:"",                       paymentLink:"",                              status:"unpaid"} },
];
...
const Settings = ({user}) => {
  ...
  const zipHistory=JSON.parse(localStorage.getItem("ws_zips")||'["30542","30501","30518"]');
